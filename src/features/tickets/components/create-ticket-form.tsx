...
export function CreateTicketForm() {
  ...
  const selectClassName = cn(
    "h-8 w-full rounded-lg border border-zinc-300 bg-white px-2.5 text-sm shadow-xs",
    "outline-none transition-colors focus-visible:border-zinc-500 focus-visible:ring-3 focus-visible:ring-zinc-400/25",
